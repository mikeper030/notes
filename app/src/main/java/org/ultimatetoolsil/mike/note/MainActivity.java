...
//    private String isFirsttime=null;
    ...
    public void onBackPressed() {
        addnoteFragment test = (addnoteFragment) getSupportFragmentManager().findFragmentByTag("note");
...
//
//                ArrayList<Item> olditems=utils.getallsaveditems(this);
//                items=new ArrayList<>();
...
//            long lastUpdateTime = context.getPackageManager().getPackageInfo(getPackageName(), 0).lastUpdateTime;
...
//        boolean result=true;
//        if(PreferenceManager.getDefaultSharedPreferences(MainActivity.this).getString("first",null)==null)
//            PreferenceManager.getDefaultSharedPreferences(MainActivity.this).edit().putString("first", "asfd").apply();
//             else
//                result= false;
//        return result;
//        }
